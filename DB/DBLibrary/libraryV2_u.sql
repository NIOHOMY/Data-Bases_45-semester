...
DROP VIEW archived_books;
DROP VIEW confirmed_issues;
DROP VIEW pending_confirmation_issues;
DROP VIEW admins;
DROP VIEW managers;
DROP FUNCTION get_user_by_reader_email;
...
COMMENT ON COLUMN issuebook.returndate IS 'Дата возврата книги';
