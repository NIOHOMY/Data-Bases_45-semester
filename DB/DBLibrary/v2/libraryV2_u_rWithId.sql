...
ALTER TABLE readers 
	  ADD CONSTRAINT readers_user_fk FOREIGN KEY (user_id) 
...
INSERT INTO readers (email, first_name, last_name, patronymic, address, phone_number, user_id)
VALUES ('ivanov@e.com', 'Иван', 'Иванов', 'Иванович', 'ул. Пушкина, д. 1, кв. 10', '8-800-555-35-35', 1);

INSERT INTO readers (email, first_name, last_name, patronymic, address, phone_number, user_id)
VALUES ('petrov@e.com', 'Петр', 'Петров', 'Петрович', 'ул. Лермонтова, д. 5, кв. 20', '8-800-555-34-34', 2);

INSERT INTO readers (email, first_name, last_name, patronymic, address, phone_number, user_id)
VALUES ('sidorov@e.com', 'Сидор', 'Сидоров', 'Сидорович', 'ул. Гоголя, д. 3, кв. 15', '8-800-555-33-33', 3);

INSERT INTO readers (email, first_name, last_name, patronymic, address, phone_number, user_id)
VALUES ('kuznetsov@e.com', 'Кузьма', 'Кузнецов', 'Кузьмич', 'ул. Толстого, д. 11, кв. 30', '8-800-555-32-32', 4);

INSERT INTO readers (email, first_name, last_name, patronymic, address, phone_number, user_id)
VALUES ('novikova@e.com', 'Анна', 'Новикова', 'Владимировна', 'ул. Пушкина, д. 2, кв. 5', '8-800-555-31-31', 5);
